...
public class PlayerG3 extends Player{
	...
	public Set<Light> getLights() {
		 ...
		 */
		Light center = new Light(50, 50, 60, 30, 30);
		
		//Light center = new Light(50, 50, 30, 15, ON_TIME * 4);
		
		log.trace("Positioned a light at (" + center.getX() + ", " + center.getY() + ")");
		ret.add(center);
		
		
		Light aux1 = new Light(32, 50, INTERVAL_TIME - 90, ON_TIME, START_TIME);
		Light aux2 = new Light(68, 50, INTERVAL_TIME - 90, ON_TIME, START_TIME);
		Light aux3 = new Light(50, 32, INTERVAL_TIME - 90, ON_TIME, START_TIME);
		Light aux4 = new Light(50, 68, INTERVAL_TIME - 90, ON_TIME, START_TIME);
